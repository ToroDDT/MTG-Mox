			...
			<TextField
				...
				sx={{
					...
					'& .MuiOutlinedInput-root': {
						'& fieldset': { borderColor: '#cccccc', transition: 'border-color 0.3s ease, box-shadow 0.3s ease' },
						'&:hover fieldset': { borderColor: '#999999' },
						'&.Mui-focused fieldset': { borderColor: 'rgba(128, 0, 128, 0.7)', boxShadow: '0 0 0 2px rgba(128, 0, 128, 0.2)' },
					},
				}}
			/>
