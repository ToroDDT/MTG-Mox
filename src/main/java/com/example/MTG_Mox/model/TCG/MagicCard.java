...
public class MagicCard {
  ...
  public MagicCard(String id, String name, String object, String oracleId, List<Integer> multiverseIds,
      Integer mtgoId,
      Integer tcgplayerId, Integer cardmarketId, String lang, String releasedAt, String uri,
      String scryfallUri,
      String layout, boolean highresImage,
      String imageStatus, Map<String, String> imageUris, String manaCost, Integer cmc,
      String typeLine,
      ...
      List<String> finishes, boolean oversized, boolean promo, boolean reprint, boolean variation,
      String setId,
      ...
      List<String> artistIds, String illustrationId, String borderColor, String frame,
